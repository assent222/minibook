...
public class OfferComparatorTest {
    private MiniBook.OfferComparator comparator;

    @Before
    public void before() {
        comparator = new MiniBook.OfferComparator();
    }
    ...
    public void compareTransitive() throws Exception {
        ...
        a = new Order("Q1", OrderType.BID, new BigDecimal("1.123"), new BigInteger("1000"), 1000);
        b = new Order("Q1", OrderType.BID, new BigDecimal("11.123"), new BigInteger("1000"), 1000);
        c = new Order("Q1", OrderType.BID, new BigDecimal("111.123"), new BigInteger("1000"), 1000);
